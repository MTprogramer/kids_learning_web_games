...
const Pattern = (() => {
  ...
  const levels = [
    { patternLen: 2, seqLen: 5, rounds: 5 },  // AB pattern, show 5 elements
    { patternLen: 3, seqLen: 7, rounds: 5 },  // ABC pattern
    { patternLen: 4, seqLen: 9, rounds: 5 },  // AABB/ABCD complex
  ];
  ...
  function nextRound() {
    ...
    container.innerHTML = `
      <div class="desen-game">
        <div class="desen-progress">Pattern ${round}/${totalRounds}</div>
        <div class="desen-instruction">What should come next?</div>
