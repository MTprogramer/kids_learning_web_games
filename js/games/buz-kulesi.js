...
const BuzKulesi = (() => {
    ...
    function showComboFlash(c) {
        ...
        comboFlashEl.textContent = 'x' + c + ' KOMBO!';
    ...
    function showGameOverModal(isNewRecord) {
        ...
        const retryBtn = h('button', {
            class: 'bk-mbtn bk-mbtn-primary', type: 'button', text: '↻ Tekrar Dene',
            onClick: () => {
        ...
        const card = h('div', { class: 'bk-modal-card' },
            h('div', { class: 'bk-modal-title', text: '❄️ Düştün! ❄️' }),
            h('div', { class: 'bk-modal-sub', text: 'Bir sonraki zıplamada daha yüksek!' }),
            stats,
