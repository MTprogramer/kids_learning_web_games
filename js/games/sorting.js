...
const Sorting = (() => {
    ...
    const sizeEmojis = [
        { emoji: '🐁', size: 1, name: 'Mouse' },
        { emoji: '🐱', size: 2, name: 'Cat' },
        { emoji: '🐕', size: 3, name: 'Dog' },
        { emoji: '🐎', size: 4, name: 'Horse' },
        { emoji: '🐘', size: 5, name: 'Elephant' },
        { emoji: '🐛', size: 0.5, name: 'Bug' },
        { emoji: '🐰', size: 1.5, name: 'Rabbit' },
        { emoji: '🦁', size: 3.5, name: 'Lion' },
        { emoji: '🐻', size: 4.5, name: 'Bear' },
        { emoji: '🦒', size: 5.5, name: 'Giraffe' },
    ];
    ...
    function startRound(level) {
        ...
        if (config.type === 'size' || config.type === 'mixed') {
            ...
            instructionText = 'Sort the animals from smallest to largest!';
        }
        ...
        if (config.type === 'number') {
            ...
            instructionText = 'Sort the numbers from smallest to largest!';
        }
        ...
        // Click on slots - undo placed item
        slots.forEach(slot => {
