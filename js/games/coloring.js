/* ============================================
   GAME: Coloring - Gallery System
   10 drawings, section logic (not levels)
   ============================================ */
...
const Coloring = (() => {
    ...
    // 10 SVG drawings
    const drawings = [
        { name: 'House', emoji: '🏠', viewBox: '0 0 200 200', regions: [
        ...
        { name: 'Flower', emoji: '🌸', viewBox: '0 0 200 200', regions: [
        ...
        { name: 'Butterfly', emoji: '🦋', viewBox: '0 0 200 200', regions: [
        ...
        { name: 'Car', emoji: '🚗', viewBox: '0 0 200 200', regions: [
        ...
        { name: 'Sun', emoji: '☀️', viewBox: '0 0 200 200', regions: [
        ...
        { name: 'Tree', emoji: '🌳', viewBox: '0 0 200 200', regions: [
        ...
        { name: 'Fish', emoji: '🐟', viewBox: '0 0 200 200', regions: [
        ...
        { name: 'Star', emoji: '⭐', viewBox: '0 0 200 200', regions: [
        ...
        { name: 'Cat', emoji: '🐱', viewBox: '0 0 200 200', regions: [
        ...
        { name: 'Rainbow', emoji: '🌈', viewBox: '0 0 200 200', regions: [
    ...
    function showGallery() {
        ...
        title.textContent = 'Choose the picture you want to paint!';
