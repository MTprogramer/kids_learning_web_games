...
const EN = {
    ...
    instructions: {
        ...
        'eat-fruit': 'Move the monster to catch the falling fruit!',
        ...
        'bubble-buster': 'Pop the bubble pairs that add up to the target sum!',
        'math-fusion': 'Tap to drop number balls — match equal numbers to fuse them!',
